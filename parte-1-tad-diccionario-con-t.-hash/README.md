...
En esta primera parte, realizaremos la implementación de un **Tipo Abstracto de Datos (TAD) Diccionario mediante una tabla&#x20;**_**hash**_. Este Diccionario permanente acceder a una colección de elementos mediante el uso de claves de acceso, trabajando con lo que comúnmente llamamos **pares&#x20;**_**clave→valor**_. La **clave será un tipo&#x20;**_**string**_ mientras que el valor será de tipo paramétrico, concretándose cuando se cree un objeto Diccionario.
